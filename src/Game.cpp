...
void Game::update()
{
	...
	while (window->pollEvent(event))
	{
		...
		c2Capsule_player.a.x = 350;
		c2Capsule_player.a.y = 100;
		c2Capsule_player.b.x = 400;
		c2Capsule_player.b.y = 100;

		c2Capsule_player.r = 25;

		c2Circle c2Circle_player;
		c2Circle_player.p.x = 50;
		c2Circle_player.p.y = 200;
		c2Capsule_player.r = 25;
